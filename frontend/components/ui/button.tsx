...
export function Button({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-saffron-500 to-saffron-600 text-white hover:from-saffron-600 hover:to-saffron-700 focus:ring-saffron-500 shadow-lg shadow-saffron-500/25',
